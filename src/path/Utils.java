...
public class Utils {
    ...
    public static double contrain(double value, double a, double b){
        if (value < a) return a;
        else if (value > b) return b;
        else return value;
    }

    public static double map(double value, double currentRangeStart, double currentRangeStop,
                             double targetRangeStart, double targetRangeStop) {

        return targetRangeStart + (targetRangeStop - targetRangeStart) *
